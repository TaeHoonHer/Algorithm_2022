...
//		a[i] = pivot;
		...
		int pivot=a[i]; //leftmost value 퀵-1
		int p=i;
		int temp;
...
//		}
		...
		Sorting.insertionSort(arr);		//삽입정렬
//		Sorting.selectionSort(arr);		//선택정렬
//		Sorting.bubbleSort(arr);		//버블정렬
//		Sorting.flagbubbleSort(arr);	//버블정렬 수정, 정렬되면 프로그램 끝
		
//		Sorting.quickSort(arr);			//퀵정렬
//		Sorting.heapSort(arr);			//히프
//		Sorting.mergeSort(arr);			//합병
