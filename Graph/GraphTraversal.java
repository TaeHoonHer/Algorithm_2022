...
class Graph1 {
   ...
   public void build() {
      Node tmpNode;
      tmpNode = new Node(5, null);
      tmpNode = new Node(0, tmpNode);
      header[0] = new Node(1, new Node(4, null));;
      // you can do it this way
      header[1] = tmpNode;
      header[2] = new Node(3, new Node(5, new Node(6, null)));
      header[3] = new Node(2, new Node(7, null));
      header[4] = new Node(0, null);
      header[5] = new Node(1, new Node(2, new Node(6, null)));
      header[6] = new Node(2, new Node(5, new Node(7, null)));
      header[7] = new Node(3, new Node(6, null));
   }
...
public class GraphTraversal {
   ...
   public static void main(String[] args) {
      ...
      g1.build();
      System.out.println("print Graph1 ");
      g1.printList();
